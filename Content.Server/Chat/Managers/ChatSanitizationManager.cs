...
public sealed class ChatSanitizationManager : IChatSanitizationManager
{
    ...
    [
        ...
        Entry("…!", "chatsan-wide-eyed"), //DeltaV (note that `...` doesn't work as that turns into a radio message)
        Entry("…?", "chatsan-uncertain"), //DeltaV (who uses `…` instead of `...`? me! i do that. compose key go brr)
        Entry("…", "chatsan-sighs"), //DeltaV 
    ];
